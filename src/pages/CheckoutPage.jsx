...
export default function CheckoutPage({
  ...
  if (showReceipt) {
    return (
      <div className="min-h-screen bg-[#FDF6F0] relative">
        <div 
        ...
        />
        <div className="relative z-10 flex flex-col font-sans items-center py-8 px-4 pb-24">
        {/* Toast Alert */}
        {toast.show && (
  ...
  // Form checkout view
  return (
    <div className="min-h-screen bg-[#FDF6F0] text-[#4A3222] font-sans relative">
      <div 
        className="fixed inset-0 pointer-events-none opacity-[0.35]" 
        style={{ backgroundImage: "url('/batik.jpeg')", backgroundRepeat: 'repeat', backgroundSize: '400px' }}
      />
